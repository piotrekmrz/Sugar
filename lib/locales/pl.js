...
Sugar.Date.addLocale('pl', {
  ...
  'units':     'milisekund:a|y|,sekund:a|y|,minut:a|y|,godzin:a|y|,dzień|dni|dni,tydzień|tygodnie|tygodni,miesiące|miesiące|miesięcy,rok|lata|lat',
  ...
  'relative': function(num, unit, ms, format) {
    ...
    switch(true) {
      ...
      case num >= 12 && num <= 14: mult = 2; break;
    ...
    switch(format) {
      ...
      case 'past':      return numberWithUnit + ' temu';
      case 'future':    return 'przed ' + numberWithUnit;
    }
  },
  'timeMarker':'o',
  'ampm':      'am,pm',
